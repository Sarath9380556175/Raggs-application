...
class Items extends React.Component{
    ...
    componentDidMount()
    {
        ...
        axios({
            url:'https://dry-citadel-95113.herokuapp.com/itemslist',
            method:'POST',
...
getData = (data) => {
    return fetch(`https://dry-citadel-95113.herokuapp.com/payment`, {
        method: "POST",
        headers: {
...
makePayment = (e) => {
    ...
    axios({
        url:'https://dry-citadel-95113.herokuapp.com/paymentform',
        method:'POST',
        headers:{'content-Type':'application/json'},
        data:
        {
    ...
    <div onClick={()=>this.handleClick('ismodalopen',false)} style={{float:'right',marginTop:'-49px',fontSize:'20px',fontStyle:'italic',color:'gold',marginRight:'-16px'}}>close</div>
       ...
       <button className="btn btn-primary">proceed</button>
            ...
            :<div style={{fontSize:'25px',fontStyle:'italic',fontFamily:'serif'}}>No Item Found</div>}
