...
<div className="container-fluid jumbotron text-center" style={{background:"url(Assets/restaurantlogo.jpg)"}}>
  ...
  <div className="logo">
  <p className="skrs">{googleimage?<img src={`${googleimage}`} className="rounded-circle" width="160px" height="115px" style={{borderRadius:'50%',marginTop:'-23px'}} alt="Nothing Found"/>: <div>SKR <i className="fas fa-coffee bg-warning rounded" id="top"></i> <b>R</b>estaurant</div>}</p>
</div>
<br/><br/>
